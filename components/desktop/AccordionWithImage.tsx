  ...
  return (
    <section className="bg-light-bg">
      <div className="flex items-center justify-center px-[60px]">
        <div className="bg-white rounded-[24px] shadow-lg w-full p-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex items-start justify-center">
            <div className="relative w-full max-w-[826px] h-[628px] rounded-[20px] overflow-hidden shadow-xl">
              <Image
                src={defaultImage}
